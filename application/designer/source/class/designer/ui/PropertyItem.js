...
qx.Class.define("designer.ui.PropertyItem", {
    ...
    /** TODOC
     */
    construct: function(genID, prop, val) {
        this.base(arguments);
    ...
    members: {
        ...
        __onClick: function(e) {
            ...
            if (def["check"] == "String") {
                this.add(new designer.selector.String(this.getGeneratedId(), this.getPropname()), {row: 1, column: 0, colSpan: 2});
            } else if (def["check"] == "Number") {
                this.add(new designer.selector.Float(this.getGeneratedId(), this.getPropname()), {row: 1, column: 0, colSpan: 2});
            } else if (def["check"] == "Boolean") {
                this.add(new designer.selector.Boolean(this.getGeneratedId(), this.getPropname()), {row: 1, column: 0, colSpan: 2});
            } else {
                this.add(new designer.selector.Json(this.getGeneratedId(), this.getPropname()), {row: 1, column: 0, colSpan: 2});
            }
