...
qx.Class.define("designer.placeholder.Window", {
    ...
    members: {
        ...
        _applyGeneratedId : function(value, old) {
            ...
            //this.debug("Adams: Window, innerLayout constructor setting:"+this.getConstructorSettingByName("innerLayout"));
            //this.debug("Adams: Window, thing generated by generateLayout"+blueprint.util.Misc.generateLayout(this.getConstructorSettingByName("innerLayout")));
